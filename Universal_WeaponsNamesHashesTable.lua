--Weapon Hashes and Names table Generated by 2TAKE1
--Made by Keramis/Scriptcat
GLOBAL_WEAPONS_NAMES_HASHES_TABLE = {
    ...
    {3676729658, "Compact EMP Launcher"},
    ...
    --to use this table: column 1 is the hash, column 2 is the name.
    --to print everything in order, do:
    
    -- for i = 1, #weaponNamesAndHashes do
    --     print(weaponNamesAndHashes[i][1] .. " " .. weaponNamesAndHashes[i][2])
    -- end